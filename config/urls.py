...
urlpatterns = [
    ...
    path("ingenieria/apoyo/<int:apoyo_id>/editar/", editar_apoyo, name="editar_apoyo"),
    path("ingenieria/apoyo/<int:apoyo_id>/despachar-bodega/", despachar_bodega_apoyo, name="despachar_bodega_apoyo"),
